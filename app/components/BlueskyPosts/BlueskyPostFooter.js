export default function BlueskyPostFooter({ post }) {
  ...
  const replySvg = (
    <svg
      ...
      viewBox="0 0 24 24"
      height="17"
      className={`inline stroke-neutral-700 dark:stroke-neutral-500`}
    >
      <path
        fill="hsl(211, 20%, 56%)"
        fillRule="evenodd"
  ...
  const repostSvg = (
    <svg
      ...
      viewBox="0 0 24 24"
      height="17"
      className={`inline stroke-neutral-700 dark:stroke-neutral-700`}
    >
      <path
        fill="hsl(211, 20%, 56%)"
        fillRule="evenodd"
  ...
  return (
    <div
      className={`pt-3 grid grid-flow-col justify-start space-x-6 text-xs text-neutral-700 dark:text-neutral-300`}
    >
      <div>
        {replySvg} {replyCount}
      </div>
